...
class CreateRoute extends Dbh {
    ...
    protected function setRoute($location, $heure,$arrivee,$date,$place,$etapes,$road,$etapes1,$etapes2,$final_hour,$step_hour1,$step_hour2,$gp1,$gp2,$gps3){
        $id = $_SESSION["userid"];
        ...
        $result = $stmt->execute(array($location,$etapes1,$etapes2,$arrivee,$date,$heure,$road,$place,$etapes,$id,$step_hour1,$step_hour2,$final_hour,$gp1,$gp2,$gps3));
