                ...
                <div class="pb-6">
                    ...
                    <div id="textpara" class="w77 overpass">
                        <p class="overpass">Tu es nouveau dans la formation et tu cherches quelqu'un faisant le même
                            ...
                            venir en
                            formation.</p>
                        <p class="overpass">Pas de soucis <span class="redColor">blabla Campus</span> est là pour toi.
                        </p>
                        <p class="overpass">Crée toi un compte ou connecte toi pour soit proposer un covoiturage, soit
                            pour voir toutes
                            les
