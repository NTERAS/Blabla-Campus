        ...
        <div id="divright"
            ...
            <!-- <main class="dekstop box"> -->
                ...
                <div class="container is-flex is-justify-content-center is-flex-direction-column my-5">
                    <!-- coordonnées -->
                    <p class="bungee my-4 mx-3">Proposer un trajet</p>

        <form action="PHP/includes/create-route.inc.php" class="loginForm is-flex is-flex-direction-column container"
            method="GET" enctype="multipart/form-data" autocomplete="off">

            <!-- depart -->
            <div class="control has-icons-left enAvant w100 firstAutoC">
            ...
            <div class="control has-icons-left">
                ...
                <input type="time" name="heure" id="heure" class="input is-medium" placeholder="Heure" value=""
                    required="required">
            </div>
            <!-- arrivée -->
            <div class="control has-icons-left my-3 w100">
                ...
                <div class="select w100">
                    <p for="arrivee" class="greyText mb-2 w100">Pour allez où ?</p>
                    <select name="arrivee" id="arrivee" class="w100 decorated">
                        <option value="" disabled selected>Destination</option>
                        <option class="hoverRed" value="Centre Avenue du Stade">Centre Avenue du Stade</option>
                        <option class="hoverRed" value="Campus numérique">Campus numérique</option>
                    </select>
                </div>
            ...
            <div class="control has-icons-left pt-3 my-5">
                <p for="date" class="greyText mb-2">Quand partez vous ?</p>
            ...
            <div class="is-flex is-justify-content-space-around">
                <label class="checkbox">
                    <input type="radio" name="road" value="simple" checked="true">
                    Allez simple
                </label>
                <label class="checkbox">
                    <input type="radio" name="road" value="retour">
                    Allez / retour
                </label>
            </div>
            <!-- nombre de place disponible -->
            <div class="control has-icons-left mt-3 ">
                <p for="place" class="greyText mb-2">Nombre de place disponible : </p>
                <span class="icon is-small is-left mt-3 people"><svg width="20" height="19" viewBox="0 0 20 19"
