        ...
        <div id="divright"
            ...
            <main class="dekstop main">
                ...
                <div class="container is-flex is-justify-content-center is-flex-direction-column my-5">
                    ...
                    <form action="PHP/includes/create-route.inc.php"
                        ...
                        <div class="control has-icons-left my-3 w100">
                            ...
                            <div class="select w100">
                                ...
                                <select name="arrivee" id="arrivee" class="w100 decorated">
                                    ...
                                    <option class="hoverRed" value="Centre Avenue du Stade">Centre Avenue du Stade
                                    </option>
                        ...
                        <div class="control has-icons-left mt-3 ">
                            ...
                            <span class="icon is-small is-left mt-3 people"><svg width="20" height="19"
                            ...
                            <input type="number" name="place" id="place" class="input is-medium"
                                placeholder="Places disponibles" value="" min="1" max="8">
                        </div>
                        <!-- etapes éventuelles -->
