...
<body>
    <section id="containerbox" class="w100 minh100 is-flex is-justify-content is-align-items-center">
        ...
        <form action="PHP/includes/search-route.inc.php" class="loginForm is-flex is-flex-direction-column container"
            method="GET" enctype="multipart/form-data" autocomplete="false">
